...
// Also, Unity can't transform our matrix in their model matrix. I copied a converter to read the right
// quaternion value from the matrix for the rotation.
...
public class Trans : MonoBehaviour {
    ...
    public Quat Rotation {
        ...
        set {
            rotation = value;
            // I haven't written a quaternion class yet.
    ...
    // I don't know how quaternions work yet, so I can not create a matrix with all 3 properties at once.
    // Also it's not that simple to read the changed rotation as a vector.
    ...
    private void CreateMatrixFromPositionRotationScale() {
        ...
        // keep in mind, the wikipedia articles are row major
    ...
    public void Translate(Vec3 translation) {
        // https://en.wikipedia.org/wiki/Translation_(geometry)
        // Again, Unity is column major and the wikipedia article is row major. We have to invert the matrix.
    ...
    public void RotateY(float angle) {
        ...
        // https://en.wikipedia.org/wiki/Rotation_matrix
        // the Z axis is the Y axis in unity
        // Again, Unity is column major and the wikipedia article is row major. We have to invert the matrix.
    ...
    public void RotateZ(float angle) {
        ...
        // https://en.wikipedia.org/wiki/Rotation_matrix
        // the Y axis is the Z axis in unity
        // Again, Unity is column major and the wikipedia article is row major. We have to invert the matrix.
    ...
    // copied this from my own engine. Didn't bother to understand it yet.
